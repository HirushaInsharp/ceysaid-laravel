...
<section id="data-thumb-view" class="data-thumb-view-header">
    <div class="action-btns">
        <a href="{{ route('admin.testimonials.create')}}" class="btn btn-primary px-1 py-1 waves-effect waves-light">
            Add New
        </a>
    </div>
    <div class="table-responsive">
        <!-- Data list view starts -->
        <table class="table data-thumb-view display dataTable" id="testimonial-table">
            <thead>
                <tr>
                    <th style="width: 5%">Id</th>
                    <th style="width: 10%">NAME</th>
                    <th style="width: 45%">Testimonial</th>
                    <th style="width: 20%">Tours</th>
...
@push('admin-js')
    <script>
        var testimonialTable = $("#testimonial-table").ceysaidTable({
            processing: true,
            serverSide: true,
            paging: true,
            pageLength: 10,
