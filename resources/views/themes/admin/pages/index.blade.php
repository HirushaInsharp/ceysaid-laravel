                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            var html = '<a href="' + url +
                                '"><span class="action-edit text-primary"><i class="feather icon-edit"></i></span></a>';
                            ...
                            if (data > 3) {
                                if (row.status) {
                                    html +=
                                        '<button class="datatable-button" type="submit"><span class="action-edit text-danger"><i class="feather icon-minus-circle"></i></span></button>';
                                } else {
                                    html +=
                                        '<button class="datatable-button" type="submit"><span class="action-edit text-success"><i class="feather icon-plus-circle"></i></span></button>';
                                }
                            }
